...
Then configure your MCP client (see [MCP Integration](/integrations/mcp)).
...
- **Configure access control**: [AI Access Control](/configuration/reference)
- **Secure your setup**: [Security Best Practices](/security/best-practices)
- **Integrate with your platform**: [MCP Integration](/integrations/mcp) | [OpenAI Integration](/integrations/openai) | [Gemini Integration](/integrations/gemini)
- **Learn all commands**: [CLI Reference](/cli-reference/commands)
