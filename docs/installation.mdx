...
### Python Native Binding (v1.2.0+)

For Python-first workflows, install the native Rust core:
...
- Faster cryptographic operations via Rust
- Same CLI commands as Node.js version
- Full compatibility with existing config files
...
**Note**: The Python package requires Rust toolchain for installation from source. Pre-built wheels are available for most platforms.
